...
import 'package:zing/homePage.dart';
import 'package:zing/order_screen.dart';
import 'package:zing/profile_page.dart';
import 'package:zing/search%20page.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  List currentTab = [
    ZingHomePage(),
    CartScreen(whareItComes: true),
    ProfilePage(whareItComes: true),
    OrderScreen(whareItComes: true,)
  ];
  int currentScreen = 0;
      ...
      actions: [
        ...
        Padding(
          ...
          child: InkWell(
              ...
              child: currentScreen == 1? Icon(Icons.shopping_bag):Icon(Icons.shopping_cart_sharp)),
        )
      ],
    );
