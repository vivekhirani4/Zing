...
import '../modules/dashboard/cartScreen.dart';
import '../modules/dashboard/homePage.dart';
import '../modules/dashboard/order_screen.dart';
import '../modules/dashboard/profile_page.dart';
...
List currentTab = [
  const ZingHomePage(),
  const CartScreen(whareItComes: true),
  const ProfilePage(whareItComes: true),
  const OrderScreen(whareItComes: true,)
];